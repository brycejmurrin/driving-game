 ...
 * Same engine as Neon Swarm / Neon Slice, plus quadP() for the
 * perspective road trapezoids.
 */
"use strict";
...
const Renderer = (function () {
  ...
  // Free-form quad; vertices in clockwise order (e.g. TL, TR, BR, BL).
  function quadP(x1, y1, x2, y2, x3, y3, x4, y4, color) {
